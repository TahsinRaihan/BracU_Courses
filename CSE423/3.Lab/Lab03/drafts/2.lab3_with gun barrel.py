...
follow_camera = False
camera_angle = 0
camera_height = 900  # Increased default camera height
game_paused = False
...
class Bullet:
    ...
    def draw(self):
        ...
        glutSolidCube(1)  # Draw as cube instead of sphere
        glPopMatrix()
...
def draw_gun():
    ...
    #     # Draw partial arms (lower arms only)
    #     glColor3f(0.8, 0.7, 0.6)  # Skin color
    #     quad = gluNewQuadric()
        
    #     # Right arm (holding gun)
    #     glPushMatrix()  # Right arm matrix
    #     glTranslatef(8, 20, -5)
    #     glRotatef(45, 0, 1, 0)
    #     glRotatef(-20, 1, 0, 0)
    #     gluCylinder(quad, 2.5, 2.0, 25, 12, 2)
    #     glPopMatrix()  # Right arm matrix pop
    ...
    #     glPopMatrix()  # Left arm matrix pop
        
    #     # Gun (positioned between arms)
    #     glPushMatrix()  # Gun matrix
    #     glTranslatef(2, 15, -15)
    #     glRotatef(-5, 1, 0, 0)
    ...
    if follow_camera:
        ...
        glTranslatef(player_pos[0], player_pos[1] + player_height + 30, player_pos[2])
        glRotatef(player_angle, 0, 1, 0)

        # Adjusted position - moved closer and lower
        glTranslatef(4, -8, -20)  # CHANGED: from (4, -5, -15) to (4, -8, -20)
...
def draw_status():
    ...
    # Red text (original)
    glColor3f(1, 0, 0)  # Changed back to red
...
def specialKeyListener(key, x, y):
    ...
    # Up/Down arrows now move camera up/down
    ...
    if key == GLUT_KEY_LEFT:
        ...
        camera_height += 10  # Increased movement speed
    elif key == GLUT_KEY_DOWN:
        camera_height -= 10
        camera_height = max(50, camera_height)  # Don't go below ground level
