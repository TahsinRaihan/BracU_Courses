...
interface CartItem { cartId: string; qty: number; item: { id: string; name: string; price: number; }; }
interface ScheduledOrder { orderId: string; at: string; qty: number; item: { id: string; name: string; price: number; }; payment_method: string; }
