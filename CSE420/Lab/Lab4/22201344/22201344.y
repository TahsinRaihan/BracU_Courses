...
/* Declare tokens */
%token IF ELSE CHAR FOR WHILE DO BREAK INT FLOAT DOUBLE VOID RETURN SWITCH CASE DEFAULT CONTINUE PRINTLN ADDOP MULOP INCOP DECOP RELOP ASSIGNOP LOGICOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD COMMA SEMICOLON CONST_INT CONST_FLOAT ID
...
func_definition : type_specifier id_name LPAREN param_list RPAREN enter_func compound_statement
		{	
...
statement : variable_decl
	  ...
	  | FOR LPAREN expression_statement expression_statement expression RPAREN statement
	  {
			...
			ExprStmtNode* initStmt = (ExprStmtNode*)$3->get_ast_node();
			ExprStmtNode* condStmt = (ExprStmtNode*)$4->get_ast_node();
...
factor	: variable  // factor can be void
	...
	| variable INCOP 
	{
		...
		BinaryOpNode* addNode = new BinaryOpNode("+", readNode, oneNode, $1->getvartype());
	...
	| variable DECOP
	{
		...
		VarNode* readNode = (VarNode*)varNode->clone();
		ConstNode* oneNode = new ConstNode("1", "int");
		BinaryOpNode* subNode = new BinaryOpNode("-", readNode, oneNode, $1->getvartype());
