...
.DATA
    ...
    PRICE_REGULAR  DW 50
    PRICE_STUDENT  DW 30
    ADMIN_PIN      DW 1234         ; Security Access Code

    ; --- INTERFACE STRINGS (UI) ---
...
; Prints Seat Number with Leading Zero (01, 02, etc.)
DisplaySeatNum MACRO
    LOCAL PRT_DOUBLE, END_MACRO
    MOV BX, AX      ; Safe keep AX
...
; Gets Multi-digit Number from User
...
; --- FEATURE 3: BATCH BOOKING SYSTEM ---
BookTicketSystem PROC
    ...
    ; 2. ASK CATEGORY (Strict Validation Loop)
    AskTypeLoop:
        ...
        CMP AL, '2'
        JE TypeRegular
        JMP AskTypeLoop ; Ignore invalid keys
    ...
    SeatSelectLoop:
        ...
        SaveSession:
        PUSH SI ; Save Index to Stack for potential Rollback
